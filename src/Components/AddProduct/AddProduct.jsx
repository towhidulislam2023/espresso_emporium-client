        ...
        <div className='w-[85%] mx-auto'>
            ...
            <div className='my-24'>
                <div className="bg-[#F4F3F0] p-24 ">
                    <h2 className="text-3xl font-extrabold text-center shadow-inherit">Add a Coffee</h2>
                    ...
                    <form onSubmit={handelAddProduct}>
                        ...
                        <div className="md:flex mb-8">
                            <div className="form-control md:w-1/2">
                                ...
                                <label className="input-group">
                                    <input type="text" name="name" placeholder="Coffee Name" required className="input input-bordered w-full" />
                                </label>
                            </div>
                            <div className="form-control md:w-1/2 ml-4">
                                ...
                                <label className="input-group">
                                    <input type="text" required name="quantity" placeholder="Available Quantity" className="input input-bordered w-full" />
                                </label>
                            </div>
                        </div>
                        {/* form supplier row */}
                        <div className="md:flex mb-8">
                            <div className="form-control md:w-1/2">
                                ...
                                <label className="input-group">
                                    <input type="text" required name="supplier" placeholder="Supplier Name" className="input input-bordered w-full" />
                                </label>
                            </div>
                            <div className="form-control md:w-1/2 ml-4">
                                <label className="label">
                                ...
                                <label className="input-group">
                                    <input type="text" required name="taste" placeholder="Taste" className="input input-bordered w-full" />
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="md:flex mb-8">
                            ...
                            <div className="form-control md:w-1/2 ml-4">
                                ...
                                <label className="input-group">
                                    <input type="text" required name="details" placeholder="Details" className="input input-bordered w-full" />
                                </label>
                            </div>
                        </div>
                        {/* form Photo url row */}
